...
interface Agent {
  ...
  is_active: boolean;
  external_id?: string;
  configuration?: { voice_id?: string; language?: string };
  created_at: string;
}
                ...
                <TableCell colSpan={5} className="px-5 py-8 text-center">
                  <div className="space-y-3">
                    <p className="text-gray-500 dark:text-gray-400">
                      No voice agents yet. Connect Telnyx and create agents to get started.
                    </p>
                    <Button size="sm" disabled={!tenant?.id}>
                      Create New Agent
                    </Button>
                ...
                <TableRow key={agent.id}>
                  ...
                  <TableCell className="px-5 py-4 text-start">
                    <div className="flex items-center gap-2">
                      <Button size="sm" variant="outline" title="Talk">
                        Talk
                      </Button>
